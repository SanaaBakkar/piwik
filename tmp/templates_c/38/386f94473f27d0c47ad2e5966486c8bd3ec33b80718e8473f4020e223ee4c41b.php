    ...
    <div class=\"reportDocumentation\">
        ";
            ...
            if ( !twig_test_empty((($this->getAttribute(($context["properties"] ?? null), "documentation", array(), "any", true, true)) ? (_twig_default_filter($this->getAttribute(($context["properties"] ?? null), "documentation", array()))) : ("")))) {
                echo "<p>";
                echo call_user_func_array($this->env->getFilter('rawSafeDecoded')->getCallable(), array($this->getAttribute(($context["properties"] ?? $this->getContext($context, "properties")), "documentation", array())));
                echo "</p>";
            }
            // line 45
            echo "        ";
...
{%- endif %}", "@CoreHome/_dataTable.twig", "C:\\wamp\\www\\piwik\\plugins\\CoreHome\\templates\\_dataTable.twig");
    }
}
