...
class __TwigTemplate_3ea4251e845de68b21a11814262dba2c4d94ce6030426239c8502315efe5cfd3 extends Twig_Template
{
    ...
    public function getpluginDeveloper($__owner__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            if ((("piwik" == ($context["owner"] ?? $this->getContext($context, "owner"))) || ("matomo-org" == ($context["owner"] ?? $this->getContext($context, "owner"))))) {
                echo "<img title=\"Matomo\" alt=\"Matomo\" style=\"padding-bottom:2px;height:11px;\" src=\"plugins/Morpheus/images/logo-marketplace.png\"/>";
            } else {
...
{% macro missingRequirementsPleaseUpdateNotice(plugin) %}
    ...
    {% endif %}
{% endmacro %}
", "@Marketplace/macros.twig", "C:\\wamp\\www\\piwik\\plugins\\Marketplace\\templates\\macros.twig");
    }
}
